...
#         s = 0
#         for i in range(4):
#             s += Iou(class_num = i).get_iou(outputs, labels)
        
#         return s/4

        iou1 = Iou(class_num = 1)
        iou2 = Iou(class_num = 2)
        iou3 = Iou(class_num = 3)
        
        sum_iou = iou1.get_iou(outputs,labels)+iou2.get_iou(outputs,labels)+iou3.get_iou(outputs,labels)
