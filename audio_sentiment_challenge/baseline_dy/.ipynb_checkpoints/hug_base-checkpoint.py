...
def speech_file_to_array_fn(df):
    ...
    for path in tqdm(df['path']):
        speech_array, _ = librosa.load("/scratch/network/mk8574/audio_sentiment_challenge/data"+path[1:], sr=CFG['SR'])
...
submission.to_csv('./submission'+nowDatetime+'.csv', index=False)