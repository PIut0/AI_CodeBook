...
class Config:
    ...
    # save dir
    save_dir: str = "/scratch/network/mk8574/audio_sentiment_challenge/baseline_dy/save"
    ...
    lr: float = 5e-4
    batch_size: int = 16
    gradient_accumulate_step: int = 2  # total batch size = batch_size * gradient_accumulate_step
...
transforms = audiomentations.OneOf([ audiomentations.AddGaussianNoise(p=0.75)])
