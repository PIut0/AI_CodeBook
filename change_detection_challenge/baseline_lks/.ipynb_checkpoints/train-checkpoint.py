...
if __name__ == '__main__':
    ...
    # Load image scaler
    error_data_list = ['2017_KAG_2LB_000912.png', '2019_KBG_3LB_000073.png', '2019_KDG_2LB_000871.png', '2019_WSN_2LB_000047.png', '2019_JNG_1LB_000005.png', '2019_KSG_2LB_000374.png', '2019_SMG_1LB_000027.png', '2018_KBG_2LB_000284.png', '2018_SBG_2LB_000004.png', '2018_SPG_2LB_000107.png']
    
    train_img_paths = glob(os.path.join(train_dirs, 'x', '*.png'))
    train_img_paths = [path for path in train_img_paths if os.path.basename(path) not in error_data_list]
